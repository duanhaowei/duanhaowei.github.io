...
game.States.preload = function() {
    this.preload = function() {
        ...
        game.load.image('background', 'assets/background(4).png');
        game.load.image('home', 'assets/home.png');
        game.load.image('ground', 'assets/ground(3).png');
        game.load.image('title', 'assets/title.png');
        game.load.image('bird', 'assets/bulb.png');
        //game.load.spritesheet('bird', 'assets/bird.png', 34, 24, 3);
        game.load.image('btn', 'assets/start-button(4).png');
...
game.States.menu = function() {
    this.create = function() {
        ...
        var home = game.add.tileSprite(0, 0, game.width, game.height, 'home');
        /*var titleGroup = game.add.group();
        titleGroup.create(0, 0, 'title');
        var bird = titleGroup.create(190, 10, 'bird');
        bird.animations.add('fly');
        bird.animations.play('fly', 12, true);//扇动翅膀次数
        titleGroup.x = 35;
        titleGroup.y = 100;
...
game.States.play = function() {
    this.create = function() {
        this.bg = game.add.tileSprite(0, 6, game.width, game.height, 'background');
        this.pipeGroup = game.add.group();
        this.pipeGroup.enableBody = true;
        this.ground = game.add.tileSprite(0, 230, game.width, game.height, 'ground');
        ...
        this.readyText = game.add.sprite(game.width/2, 40, 'ready_text');
        this.playTip = game.add.sprite(game.width/2, 300, 'play_tip');
    ...
    this.update = function() {
        ...
        this.bg.tilePosition.x += -(this.gameSpeed/500);
        //this.ground.tilePosition(-this.gameSpeed, 0);
        game.physics.collide(this.bird, this.ground, this.hitGround, null, this);
        game.physics.overlap(this.bird, this.pipeGroup, this.hitPipe, null, this);
    ...
    this.startGame = function() {
        ...
        this.timer = game.time.events.loop(900, this.generatePipes, this);
        var style = { font: "30px Arial", fill: "#ffffff" };
        this.label_score = game.add.text(20, 20, "50亿", style);
    ...
    this.showGamePassText = function () {
    ...
    this.showGameOverText = function() {
        ...
        var gameOverText = this.gameOverGroup.create(game.width/2, 100, 'game_over');
    ...
    this.checkScore = function(pipe) {
        if(!pipe.hasScored && pipe.y <= 0 && pipe.x <= this.bird.x - 17 - 54) {
            ...
            /*this.scoreText.text =*/
            this.score += 10;
            this.label_score.content = this.score+'亿';
